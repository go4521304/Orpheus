...
define config.name = _("orpheus_v")
...
## define config.main_menu_music = "main1.mp3"

define config.main_menu_music = main1
...
define config.save_directory = "orpheus_v-1696847720"
