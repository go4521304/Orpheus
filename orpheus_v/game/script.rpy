...
label start:
    ...
    q "하! 죽은 아내를 되찾으러 단신으로 지옥에 뛰어든 미친놈아, 잘들어. 넌 이미 유명인이야. 내 이름은 매곳! 지옥은 널 환영한다! 그리고 너의 선택을 후회하게 만들 자신이 있지."
    o "그래, 여기가 시험대란 말인가?"
    ...
    "그래, 마지막으로 이야기를 들어본다"
    ma "뭐야, 아직 뭣도 몰라서 햇병아리처럼 구는게 참 귀엽네. 아직도 지옥 입구조차도 찾지 못한 모습이 안쓰러워서 얘기해준다. 강을 건너기 전에 금화 두 닢. 알겠지? 흐헤헿."
    ...
    m "태양신 아폴론님과 뮤즈 칼리오페 사이에서 태어난 젊은 악사 오르페우스는 신의 재능을 이어받아 세계에서 제일 아름다운 리라 연주를 선보이곤 했습니다."
    m "아르고호 대원정에서 세이렌을 리라 연주로 잠재웠을 만큼 굉장한 실력의 소유자!"
    m "원정에서 무사히 귀환한 그는 아리따운 아내 에우리디케와 함께 행복한 나날들을 보내고 있었습니다."
    m "그런데 어느 날, 누군가의 음모인지, 마침 따분했던 어떤 신의 장난인지! 아내 에우리디케는 독사에 물려 그만 우리의 품으로 돌아왔습니다."
    m "아내를 잊을 수 없었던 오르페우스는 살아있는 몸으로 지옥에, 그녀를 찾으려는 염원을 품고 마침내 도착한 것입니다."

    m "정말 슬픕니다. (흑흑) 하지만 이 정도의 사랑과 의지가 있어야 에스카토스에 어울리는 멍청한 전달자라고 할 수 있겠죠! (점잖은 목소리로) 여러분, 오래 기다리셨습니다. 오르페우스 극장, 그 어리석은 시작을 알리는 대망의 첫 곡은.."
    "슈베르트의 송어."
    ...
    ma "간단히 말하자면, 미래의 물건이다. 지옥은 시간의 개념이 희박하지. 뒤틀려 있거든. 오늘 죽은 사람이나, 미래에 죽은 사람이나 모두 같은 공간에 있는 거다. 만들어지는 것도 비슷하지."
    o "그렇군.."
    ...
    m "아, 벌써 하데스님께 향하는 튜토리얼을 겨우 통과한 오르페우스! 역시 최강 최흉의 머저리군요! 투철한 사랑의 힘으로 어디까지 가는겁니까! 이런 멋진 날에는 인터뷰를 빼놓을 수 없겠죠. 그럼 바로 불러보도록 하겠습니다."
    "모르페우스가 손가락을 튕기자 무대가 회전하더니 게임을 막 통과해 기진맥진한 오르페우스가 보인다."
    "갑작스런 환경의 변화에 경계를 하듯 무기를 움켜쥐는 오르페우스." 
    m "아아, 가여운 것. 아직도 이러고 있군요. 지옥 여러분, 에스카토스 시즌 666의 주인공 오르페우스에게 따뜻한 동정의 박수 부탁드립니다!"
    a "괴물들의 비웃음, 박수, 야유"
    o "…?"
    ...
    m "오늘의 메뉴는 '질투의 인터뷰', '음욕의 콘서트', 그리고 '나태의 버츄얼"
    ...
    m "엥?"
    m "이미 불바다인데 무슨 소리신지.. 공격을 하시려면 좀 더 맛있는 걸로 부탁드립니다. 별거 없으니까 시청률 떨어지잖아요"
    ...
    ap "누구인가? 잘 보이지도 않는구나. 성냥 한개비가 그대보다 밝겠구나. 어리석은 것. 가서 아들래미 기저귀나 갈아주고 오거라"
    ...
    ma "아 모르페우스? 그런데 제가 먼저 후루룩 하고 읽어보았습니다만.."
    ...
    ma "와 모르페우스, 다들 쓰레기네요?"
    m "뭐 그다지 틀린 말도 아니죠, 매곳. 어차피 결혼이라는건 얽매이는거니까요. 우리가 만들어진대로 번식에 목적을 둔다면 결혼같은건 필요 없어요"
    ma "그렇죠."
