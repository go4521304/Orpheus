...
label start:
    ...
    "태양신 아폴론님과 뮤즈 칼리오페 사이에서 태어난 젊은 악사 오르페우스는 신의 재능을 이어받아 세계에서 제일 아름다운 리라 연주를 선보이곤 했습니다."
    "아르고호 대원정에서 세이렌을 리라 연주로 잠재웠을 만큼 굉장한 실력의 소유자!"
    "원정에서 무사히 귀환한 그는 아리따운 아내 에우리디케와 함께 행복한 나날들을 보내고 있었습니다."
    "그런데 어느 날, 누군가의 음모인지, 마침 따분했던 어떤 신의 장난인지! 아내 에우리디케는 독사에 물려 그만 우리의 품으로 돌아왔습니다."
    "아내를 잊을 수 없었던 오르페우스는 살아있는 몸으로 지옥에, 그녀를 찾으려는 염원을 품고 마침내 도착한 것입니다."
    ...
    "어리석은 나의 아이 말이로구나" #머리를 짚으며
    "그래도 아폴론님을 쏙 빼닮아서 아주 사랑꾼이에요"
    "올림포스 또한 아이의 애절함을 부러워 하더구나"
    "오, 마치 나이 먹은 고약한 할아버지가 멜로 드라마를 보고 말하는 것 같네요!"
    "(발끈)"
    ...
    "네, 잘 돌아오셨습니다!"
    "이제 결혼율 급감의 원인 1위만을 남겨두고 있는데요!"
    "과연 뭘까요?"
    "대망의 1위! 그것은 바로! 데빌티비를 보면 딱히 결혼 생각 안들어서!"
    "캬, 역시 지옥 최고의 엔터테인먼트!"
    "아, 모르페우스 이거 그건데요?"
    "뭐죠 매곳?"
    "최근에 나온 논문 결과에 따르면 돈이 부족할수록 모니터 속을 들여다 보는 시간이 증가하고 생활 반경이 축소한다는 이야기가 있는데"
    "매곳, 아주 정확해요! 이딴걸 보고 즐거움을 느낄 정도면 어지간히 망한 인생이에요!"
    "빨리 나가서 누구 하나 말 걸어서 네 인생 좀 살라구요"
    "아 그렇다고 진짜 나가서 누구 하나 붙잡아서 말 걸지 마세요, 경찰서로 출두할겁니다 변태씨" # ok? you'll freak everyone out there.
    "그런데 데빌티비 은근 재밌지 않나요?"
    "그렇죠, 우리가 여러가지 많이 준비 했으니까요"
    "아직 못다한 이야기들도 많죠!"
    "쌔끈한 악마 아가씨들도 많죠!" 
